...
var file_ads_proto_rawDesc = []byte{
	...
	0x22, 0x15, 0x0a, 0x03, 0x41, 0x64, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0x0d, 0x5a, 0x0b, 0x2f, 0x76, 0x69, 0x64, 0x65,
...
func file_ads_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ads_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Ads); i {
			case 0:
				return &v.state
			case 1:
